...
public class FantService {
    ...
    /**
     * A registered user may purchase an Item. An email will be sent to the seller if the purchase is successful
     *
    ...
    /**
     * A registered user may remove an item and associated photos owned by the calling user. An user with administrator
     * privileges may remove any item and associated photos.
     *
     ...
     * @return result of the request. If successful, the request will include the new unique ids of the Item and
     * associated Photos
     */
    ...
    /**
     * Streams an image to the browser (the actual compressed pixels). The image will be scaled to the appropriate width
     * if the width parameter is provided. This is a public method available to all callers.
     *
